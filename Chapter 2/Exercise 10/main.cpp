...
pounds, shillings, and pence. There were 20 shillings to a pound, and 12 pence to a shilling. 
...
and pence, with 100 pence to a pound (like U.S. dollars and cents). 
...
int main()
{
    ...
    cout<<"Decimal Pounds = \x9c"<< fixed<<setprecision(2)<< pounds;
    return 0;
}
